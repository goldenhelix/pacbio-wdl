...
task hiphase {
  ...
  output {
    ...
    File   haplotagged_bam           = "~{sample_id}.haplotagged.bam"
    File   haplotagged_bam_index     = "~{sample_id}.haplotagged.bam.bai"
  ...
  runtime {
    docker: "~{runtime_attributes.container_registry}/hiphase:1.5.0_build1"
    cpu: threads
    memory: mem_gb + " GiB"
    disk: disk_size + " GB"
